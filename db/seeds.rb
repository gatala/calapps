...
applications = applications = [
	...
	:URL => 'http://www.ninjacourses.com', :description => "Ninja Courses makes college easier! We help you quickly plan your schedule, see professor ratings and reviews, study with past exam files, and get price comparisons for textbooks.", 
	:category => "Academic"}, 
	{:name => 'Berkeleytime', :creator => 'Yuxin Zhu, Noah Gilmore', 
	...
	:URL => 'http://www.courseflask.com', :description => "Course Flask is a tool that helps UC Berkeley students create their four-year course plan! Drag and drop classes into semesters when you want to take them, or check up on past grade distributions to see which professors you should take classes with!",
	:category => "Academic"},
